  ...
  <div>
    ...
    <div class="journal-metadata">
      <div class="metadata-item">
        ...
        <div class="metadata-value">FEB 11-12 2022</div>
      </div>
      <div class="metadata-item">
        <div class="metadata-header">
      ...
      <div class="metadata-item">
        ...
        <div class="metadata-value">DJI Mini 2, iPhone 13 Pro Max</div>
      </div>
    </div>
    ...
    <div class="photo-layout-single">
      <div class="photo-item photo-landscape">
        <PhotoMetadata 
          ...
          image-alt="The 9th Wolfpack Retreat" 
        />
      </div>
    </div>
...
<script setup>
import { PhCalendarDots, PhImages, PhCrop, PhCamera } from '@phosphor-icons/vue'
