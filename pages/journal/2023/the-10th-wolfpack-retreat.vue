<template>
  <div>
    ...
    <div class="journal-title">
      <h1>The 10th Wolfpack Retreat</h1>
    </div>
    ...
    <div class="journal-metadata">
      <div class="metadata-item">
        ...
        <div class="metadata-value">FEB 1-5 2023</div>
      </div>
      <div class="metadata-item">
        <div class="metadata-header">
      ...
      <div class="metadata-item">
        ...
        <div class="metadata-value">175</div>
      </div>
      <div class="metadata-item">
        <div class="metadata-header">
      ...
      <div class="metadata-item">
        ...
        <div class="metadata-value">35mm</div>
      </div>
    </div>
    ...
    <div class="photo-layout-single">
      <div class="photo-item photo-landscape">
        <PhotoMetadata 
          ...
          image-alt="The 10th Wolfpack Retreat" 
        />
      </div>
    </div>
