<template>
  <div>
    ...
    <div class="journal-title">
      <h1>The 5th Wolfpack Retreat</h1>
    </div>
    ...
    <div class="journal-metadata">
      <div class="metadata-item">
        ...
        <div class="metadata-value">FEB 2-4 2018</div>
      </div>
      <div class="metadata-item">
        <div class="metadata-header">
      ...
      <div class="metadata-item">
        ...
        <div class="metadata-value">188</div>
      </div>
      <div class="metadata-item">
        <div class="metadata-header">
      ...
      <div class="metadata-item">
        ...
        <div class="metadata-value">24-70mm, 50mm</div>
      </div>
    </div>
    ...
    <div class="photo-layout-single">
      <div class="photo-item photo-landscape">
        <PhotoMetadata 
          ...
          image-alt="The 5th Wolfpack Retreat" 
        />
      </div>
    </div>
