<template>
  <div>
    ...
    <div class="journal-title">
      <h1>The Liturgists Gathering, Minnesota</h1>
    </div>
    ...
    <div class="journal-metadata">
      <div class="metadata-item">
        ...
        <div class="metadata-value">NOV 16 2018</div>
      </div>
      <div class="metadata-item">
        <div class="metadata-header">
      ...
      <div class="metadata-item">
        ...
        <div class="metadata-value">180</div>
      </div>
      <div class="metadata-item">
        <div class="metadata-header">
      ...
      <div class="metadata-item">
        ...
        <div class="metadata-value">24-70mm, 70-200mm</div>
      </div>
    </div>
    ...
    <div class="photo-layout-single">
      <div class="photo-item photo-landscape">
        <PhotoMetadata 
          ...
          image-alt="The Liturgists Gathering, Minnesota" 
        />
      </div>
    </div>
