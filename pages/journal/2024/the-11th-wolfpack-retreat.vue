<template>
  <div>
    ...
    <div class="journal-title">
      <h1>The 11th Wolfpack Retreat</h1>
    </div>
    ...
    <div class="journal-metadata">
      <div class="metadata-item">
        ...
        <div class="metadata-value">FEB 22-25 2024</div>
      </div>
      <div class="metadata-item">
        <div class="metadata-header">
      ...
      <div class="metadata-item">
        ...
        <div class="metadata-value">220</div>
      </div>
      <div class="metadata-item">
        <div class="metadata-header">
      ...
      <div class="metadata-item">
        ...
        <div class="metadata-value">15mm, 35mm, 85mm</div>
      </div>
    </div>
    ...
    <div class="photo-layout-single">
      <div class="photo-item photo-landscape">
        <PhotoMetadata 
          ...
          image-alt="The 11th Wolfpack Retreat" 
        />
      </div>
    </div>
