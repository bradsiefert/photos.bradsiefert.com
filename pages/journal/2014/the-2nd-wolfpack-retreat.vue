<template>
  <div>
    ...
    <div class="journal-title">
      <h1>The 2nd Wolfpack Retreat</h1>
    </div>
    ...
    <div class="journal-metadata">
      <div class="metadata-item">
        ...
        <div class="metadata-value">NOV 15-17 2014</div>
      </div>
      <div class="metadata-item">
        <div class="metadata-header">
      ...
      <div class="metadata-item">
        ...
        <div class="metadata-value">35</div>
      </div>
      <div class="metadata-item">
        <div class="metadata-header">
        ...
        <div class="metadata-value">Fuji X-E2</div>
      </div>
      <div class="metadata-item">
        <div class="metadata-header">
        ...
        <div class="metadata-value">23mm, 56mm</div>
      </div>
    </div>
    ...
    <div class="photo-layout-single">
      <div class="photo-item photo-landscape">
        <PhotoMetadata 
          ...
          image-alt="The 2nd Wolfpack Retreat" 
        />
      </div>
    </div>
